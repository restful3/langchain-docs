---
title: Prebuilt middleware (LangChain & Deep Agents)
url: https://docs.langchain.com/oss/python/deepagents/middleware
md_endpoint: https://docs.langchain.com/oss/python/deepagents/middleware.md
fetched: 2026-05-04
note: 1주차 발표 §1.3, §6, §2.1\~§2.4 보강용. 이 페이지의 실제 제목은 "Prebuilt middleware" — LangChain core 미들웨어 카탈로그(provider-agnostic) + Deep Agents 전용 미들웨어(Filesystem / Subagent) 가 한 페이지에 정리되어 있음. 본문은 Mintlify .md 엔드포인트로 받은 raw 그대로(verbatim).
---
...
---
출처: https://docs.langchain.com/oss/python/deepagents/middleware
