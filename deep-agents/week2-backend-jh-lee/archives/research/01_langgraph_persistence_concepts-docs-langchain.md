---
title: LangGraph Persistence — Checkpoints, State Management, and Storage
url: https://docs.langchain.com/oss/python/langgraph/persistence
fetched: 2026-05-15
source_type: 1차 (official LangChain docs)
fetch_method: curl + Mintlify .md endpoint (.md suffix → raw markdown)
mapping: 교안 §5 StoreBackend 보강, §3 StateBackend 컨텍스트 (checkpoints/threads)
note: 본문은 paraphrase·요약 없이 원문 그대로. 코드 블록·표 모두 유지.
---
